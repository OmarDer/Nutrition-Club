	...
	protected void configure(HttpSecurity http) throws Exception
	{
		...
		//.and()
	 	.csrf().disable().authorizeRequests()
	 		...
	 		.antMatchers(HttpMethod.GET,"/programi/**").permitAll()
	 		.antMatchers(HttpMethod.GET,"/proizvodi/**").permitAll()
	 		.antMatchers(HttpMethod.POST,"/narudzbe/**").hasAuthority("ROLE_USER")
